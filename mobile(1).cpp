...
void sell_a_phone()
{
    for (int i = 0; i < shop.mobileArray; i++)
    {
        if (shop.mobileArray[i] == phonee.name && phone[i].company == phonee.company)
        {
...
void writeinfo()
{
    ...
    if (phone)
    {
        ...
        {
            cout << i << ")" << '\n';
            cout << shop.mobileArray[i].name << '\n';
            cout << shop.mobileArray[i].company << '\n';
            cout << shop.mobileArray[i].NumberOfAvailable << '\n';
            cout << shop.mobileArray[i].NumberOfSold << '\n';
            cout << shop.mobileArray[i].price << '\n';
        }
    }
    else
    {
